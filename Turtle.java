...
public class Turtle implements Runnable, ActionListener, MouseListener, MouseMotionListener, KeyListener, ComponentListener, MouseWheelListener
{
    ...
    public static void main(String[] a)
    {
        ...
        try {
            ...
            //use absolute path
            File file = new File("C:\\Users\\weerasak_hoithaku\\Documents\\GitHub\\Turtle\\src\\backToSchool.png");
            ...
            // Step 3: Iterate over each pixel to get the RGB values
            for (int x = 0; x < width; x++) {
                for (int y = 0; y < height; y++) {
                    bob.up();
                    bob.setPosition(x-startPointXAxis,startPointYAxis-y);
                    bob.down();
                    ...
                    Color colorAtZeroZero = pixelColors[x][y];
                    bob.penColor(colorAtZeroZero);
                    bob.forward(1);
                }
            }
